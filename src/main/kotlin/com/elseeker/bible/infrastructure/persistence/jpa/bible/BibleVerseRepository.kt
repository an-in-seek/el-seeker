...
import com.elseeker.bible.presentation.api.bible.response.BibleSearchResponse
...
interface BibleVerseRepository : JpaRepository<BibleVerse, Long> {
    ...
    @Query(
        """
        SELECT new com.elseeker.bible.presentation.api.bible.response.BibleSearchResponse(
                    b.id,
                    b.bookOrder,
                    b.name,
                    c.id,
